...
def loaddf(fp,d):
    ...
    sql2csv("RX",d)
    header = ["Filename", "ranking", "comments", "OpMode", "Test Events", "HLED Events", "Forced Events"]
    df_rx=pd.read_csv(f'{fp}/Ranking_{str(d)}.csv', names = header,na_values='')
    values = {"Filename": '', "ranking": '', "comments": '', "OpMode": -1000, "Test Events": -1000, "HLED Events": -1000, "Forced Events": -1000}
